...
var TagNavigationRenderer = class {
    ...
    for (const [key, { files, children }] of Object.entries(hierarchy)) {
      ...
      if (tagNameMatches || matchingFiles.size > 0 || Object.keys(filteredChildren).length > 0) {
        result[key] = {
          ...
          files: tagNameMatches ? /* @__PURE__ */ new Set([...files]) : /* @__PURE__ */ new Set([...matchingFiles]),
   ...
   */
  renderTagGroup(container, group, path = [], openFileCallback) {
